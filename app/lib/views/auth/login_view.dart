...
class _LoginViewState extends State<LoginView> {
        ...
        builder: (context, scrollController) => Padding(
          ...
          child: Column(
            children: [
              ...
              const Text("Termos e Política de Privacidade",
  ...
  Future<void> _login() async {
    ...
    final error = await _controller.loginWithError(
    ...
    if (error == null) {
      dev.log("👤 Utilizador logado", name: 'LoginView');
                        ...
                        Center(
                          child: MouseRegion(
                            ...
                            child: GestureDetector(
                              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const ForgotPasswordView())),
                              child: RichText(
                                text: TextSpan(
                                  text: "Esqueceste-te da palavra-passe? ",
                                  style: TextStyle(color: Colors.grey[600], fontSize: 13),
                                  children: const [TextSpan(text: "Recuperar", style: TextStyle(color: Color(0xFFCB8B8B), fontWeight: FontWeight.bold))],
                                ),
                              ),
                            ),
                          ),
                            ...
                            child: GestureDetector(
                              ...
                              child: RichText(
                                text: TextSpan(
                                  ...
                                  style: TextStyle(color: Colors.grey[600], fontSize: 13),
                                  children: const [TextSpan(text: "Criar nova conta", style: TextStyle(color: Color(0xFFCB8B8B), fontWeight: FontWeight.bold))],
                                ),
                              ),
                            ),
                          ),
